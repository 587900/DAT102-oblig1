...
public interface FilmarkivADT {
	...
	/**
	 * Søker etter en film med gitt delstreng, og returnerer en tabell med filmer
	 * som inneholder delstrengen i tittelen.
	 * 
	 * @param title - delstrengen man skal søke etter.
	 ...
	 * 
	 * @param prod - delstrengen man skal søke etter.
	 ...
	 * 
	 * @param sjanger - sjanger man vil søke etter.
